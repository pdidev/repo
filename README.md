...
```
sudo wget -O /etc/yum.repos.d/pdidev.repo https://raw.githubusercontent.com/pdidev/repo/pdi-master-sid.fedora/33/pdidev.repo
sudo dnf install pdi-devel
```
### On Fedora 32

```
sudo wget -O /etc/yum.repos.d/pdidev.repo https://raw.githubusercontent.com/pdidev/repo/pdi-master-sid.fedora/32/pdidev.repo
sudo dnf install pdi-devel
```
