...
```
sudo wget -O /etc/yum.repos.d/pdidev.repo https://raw.githubusercontent.com/pdidev/repo/pdi-1.fedora/32/pdidev.repo
sudo dnf install pdi-devel
```
### On Fedora 33

```
sudo wget -O /etc/yum.repos.d/pdidev.repo https://raw.githubusercontent.com/pdidev/repo/pdi-1.fedora/33/pdidev.repo
sudo dnf install pdi-devel
```
